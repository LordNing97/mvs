        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if (body.hasClass('page-sidebar-fixed')) {
                ...
                if (Metronic.getViewPort().width < resBreakpointMd) {
                    height = Metronic.getViewPort().height - headerHeight;
                } else {
                    height = sidebar.height() - headerHeight;

                }

                if ((height + headerHeight) <= Metronic.getViewPort().height) {
                    height = Metronic.getViewPort().height - headerHeight-1;
